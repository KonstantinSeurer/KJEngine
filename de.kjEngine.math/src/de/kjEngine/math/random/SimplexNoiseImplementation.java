 ...
 *
 */
public class SimplexNoiseImplementation implements NoiseImplementation {
...
// 4D simplex noise, better simplex rank ordering method 2012-03-09
	private static double noise(double x, double y, double z, double w) {
...
// (array access is a lot slower than member access)
	...
	public SimplexNoiseImplementation() {
	}
	...
	public float noise(float x, float y) {
		return (float) SimplexNoiseImplementation.noise((double) x, (double) y);
	}

	@Override
	public float noise(float x, float y, float z) {
		return (float) SimplexNoiseImplementation.noise((double) x, (double) y, (double) z);
	}
	
	@Override
	public float noise(float x, float y, float z, float w) {
		return (float) SimplexNoiseImplementation.noise((double) x, (double) y, (double) z, (double)  w);
	}
}
