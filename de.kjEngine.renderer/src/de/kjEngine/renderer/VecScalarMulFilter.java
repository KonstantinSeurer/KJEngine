 ...
 *
 */
public class VecScalarMulFilter extends Filter {
	...
	static {
		...
		try {
			source = PipelineSource.parse(RL.create("jar://renderer/de/kjEngine/renderer/vecScalarMul.shader"));
	...
	public VecScalarMulFilter(InputProvider input) {
